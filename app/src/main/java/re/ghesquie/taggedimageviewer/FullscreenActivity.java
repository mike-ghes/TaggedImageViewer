...
public class FullscreenActivity extends AppCompatActivity {
    ...
    private TaggedImageView mContentView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Integer value = intent.getIntExtra("index", -1);
        ...
        if (value != -1) {
            ...
            ref.child("image").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Picasso.with(getApplicationContext()).load(s).into(mContentView);
                }
    ...
    private void hide() {
        ...
        mControlsView.animate()
                .translationYBy(mControlsView.getHeight())
                .alpha(0)
                .setDuration(UI_ANIMATION_DELAY);
        mVisible = false;
